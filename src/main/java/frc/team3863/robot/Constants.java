...
public class Constants {
    public static final int leftDriveA_ID = 2;
    public static final int leftDriveB_ID = 12;
    public static final int rightDriveA_ID = 3;
    public static final int rightDriveB_ID = 15;
    ...
    public static final int shooterA_ID = 1;
